...
const Lowerbox = () => {
  ...
  const [selectedCountry, setSelectedCountry] = useState("82"); //국가선택
  ...
  return (
    <div className="Lower" style={{ position: "relative" }}>
      <div className="Box2">
        <div key={0} className={inputFocused[0] ? "NameFocused" : "Name"}>
          <FontAwesomeIcon
            className={name ? "userFilled" : "user"}
            icon={faUser}
          />
          <input
            placeholder="이름"
        ...
        <div key={1} className={inputFocused[1] ? "BirthFocused" : "Birth"}>
          <FontAwesomeIcon
            className={birthday ? "BDayFilled" : "BDay"}
        ...
        <div
          key={2}
          className={inputFocused[2] ? "PhoneNumFocused" : "PhoneNum"}
        >
          <FontAwesomeIcon
            className={phone ? "mobileFilled" : "mobile"}
            icon={faMobileScreen}
          />
          <input
            placeholder="휴대전화번호"
